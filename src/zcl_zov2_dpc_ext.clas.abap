class ZCL_ZOV2_DPC_EXT definition
  public
  inheriting from ZCL_ZOV2_DPC
  create public .
...
CLASS ZCL_ZOV2_DPC_EXT IMPLEMENTATION.
...
*}
  ...
  METHOD /iwbep/if_mgw_appl_srv_runtime~create_deep_entity.
    ...
    ELSE.
      ...
      ls_cab-clienteid  = ls_deep_entity-clientid.
    ...
    LOOP AT ls_deep_entity-toovitem ASSIGNING FIELD-SYMBOL(<ls_deep_item>).
      <ls_deep_item>-orderid = ls_cab-ordemid.
    ENDLOOP.
